...
int main (int argc, char* argv[]){
    values_t *network = init_values((int[]){300, 150, 100, OUT_LENGTH}, 4);
    connections_t *connections = init_connections((int[]){300, 150, 100, OUT_LENGTH}, 4);
